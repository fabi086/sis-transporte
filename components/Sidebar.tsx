...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, setCurrentView, userPlan }) => {
  return (
    <div className="bg-brand-blue-950 text-white w-20 lg:w-64 flex flex-col transition-all duration-300">
      <div className="flex items-center justify-center lg:justify-start lg:pl-6 h-20 border-b border-brand-blue-900">
      ...
      <div className="px-2 lg:px-4 py-4 border-t border-brand-blue-900">
